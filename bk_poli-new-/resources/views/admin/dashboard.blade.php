          ...
          <div
            ...
            <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
              <div class="flex flex-wrap mt-0 -mx-3">
                ...
                <div class="px-3 lg:flex-0 shrink-0 md:w-6/12">
                  <div
              ...
              <div class="flex flex-wrap mt-0 -mx-3">
                <div class="flex-none w-7/12 max-w-full px-3 mt-0 lg:w-1/2 lg:flex-none">
                  <ol class="list-decimal pl-6" style="list-style: decimal; color:black">
                    <li class="mb-2">Melakukan Input Dokter</li>
                    <li class="mb-2">Melakukan Input Pasien</li>
                    <li class="mb-2">Melakukan Input Poliklinik</li>
                    <li class="mb-2">Melakukan Input Obat</li>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <div class="flex flex-wrap items-center -mx-3 lg:justify-between">
            ...
            <div class="w-full max-w-full px-3 mt-0 shrink-0 lg:w-1/2 lg:flex-none">
              <ul class="flex flex-wrap justify-center pl-0 mb-0 list-none lg:justify-end">
                <li class="nav-item">
                  <a href="mailto:rifqirm15122001@gmail.com"
                    class="block px-4 pt-0 pb-1 text-sm font-normal transition-colors ease-soft-in-out text-slate-500"
                    target="_blank">Email</a>
                </li>
                <li class="nav-item">
                  <a href="https://www.instagram.com/rifqirm1512/"
                    class="block px-4 pt-0 pb-1 text-sm font-normal transition-colors ease-soft-in-out text-slate-500"
                    target="_blank">Instagram</a>
                </li>
                <li class="nav-item">
                  <a href="https://www.facebook.com/rifqi.r.m.54"
                    class="block px-4 pt-0 pb-1 text-sm font-normal transition-colors ease-soft-in-out text-slate-500"
