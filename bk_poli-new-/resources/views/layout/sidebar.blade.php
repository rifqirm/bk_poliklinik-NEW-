  ...
  <div class="h-19.5">
    ...
    <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="">
      ...
      <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand"
        style="text-transform: uppercase;">{{Auth::user()->nama}}</span>
    </a>
  </div>

  <hr class="h-px mt-0 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent" />

  <div class="items-center block w-auto max-h-screen overflow-auto grow basis-full bg-[#E5F2FF]">
    <ul class="flex flex-col pl-0 mb-0">
      @if (Auth::user()->role->nama_role == 'admin')
      <li class="mt-0.5 w-full">
        <a class="hover:shadow-soft-2xl rounded py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 colors-[#2563eb]"
          href="{{route('admin-dashboard')}}">
          <div
            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-[#E5F2FF] bg-center stroke-0 text-center xl:p-2.5">
            <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5 14H19M12 6L19 14L12 22" stroke="#1A202C" stroke-width="2" stroke-linecap="round"
